            ...
            switch (opcao) {
                ...
                case 4:
                    if (!lista.isEmpty()){
                        ...
                        System.out.println("O aluno " + a.getNome() + " de RA " + a.getRA() + " da turma " + a.getTurma() + " do " + a.getSemestre() + " semestre foi removido do final da lista." );
                    }else {
                ...
                case 5:
                    if (!lista.isEmpty()){
                        ...
                        System.out.println("O aluno " + a.getNome() + " de RA " + a.getRA() + " da turma " + a.getTurma() + " do " + a.getSemestre() + " semestre foi removido do início da lista." );
                    }else {
                        System.out.println("A lista está vazia! A operação não pode ser realizada.");
                    }
                    break;
                case 6:
                    if (!lista.isEmpty()){
                        ...
                        System.out.println("O aluno " + a.getNome() + " de RA " + a.getRA() + " da turma " + a.getTurma() + " do " + a.getSemestre() + " semestre foi removido do meio da lista." );
                    }else {
                        System.out.println("A lista está vazia! A operação não pode ser realizada.");
                    }
                    break;
